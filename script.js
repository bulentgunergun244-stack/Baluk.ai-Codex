...
document.addEventListener("click", (e) => {
  const actionBtn = e.target.closest("#plusToggle, #clearChat, #memoryToggle, #accountToggle, #thinkingToggle, #thinkingPromoClose, #drawerClose, #drawerAccountSettings, #newChatBtn, #drawerPremiumOpen, #drawerBackgroundOpen, #uiSettingsToggle, #uiSettingsClose, #voiceCloseBtn, #voiceWebBtn, #voiceMuteBtn");
  if (!actionBtn) return;
  e.preventDefault();
  e.stopPropagation();
